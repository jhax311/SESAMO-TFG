...
require_once "clases/notasEnfermeria.class.php";
include 'config.php';
//inicializamos
$_respuestas = new respuestas;
$_notasEnfermeria = new notasEnfermeria;
...
if ($_SERVER["REQUEST_METHOD"] == "GET") {
    ...
    switch ($partes[3]) {
        case '':
            //si no listamos todo
            $listaNotas = $_notasEnfermeria->listarNotas();
        ...
        default:
            if (is_numeric($partes[3])) {//comprobamos que sea un numero
                ...
                $hojaP = $_notasEnfermeria->obtenerNotasNhc(0, $nhc); 
    ...
    //enviamos todo al controlador, clas notasEnfermeria, al metodo de post
    $datosArray = $_notasEnfermeria->post($postBody);
    header("Content-Type: application/json");
