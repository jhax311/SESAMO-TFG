...
require_once "clases/hojasPre.class.php";
include 'config.php';
//inicializamos
$_respuestas = new respuestas;
$_hojasPre = new hojasPre;
...
if ($_SERVER["REQUEST_METHOD"] == "GET") {
    ...
    switch ($partes[3]) {
        case '':
            //si no listamos todo
            $listaHojas = $_hojasPre->listarHojas(null);
        ...
        default:
            if (is_numeric($partes[3])) {//comprobamos que sea un numero
                ...
                $hojaP = $_hojasPre->obtenerHojaNhc(0, $nhc); 
    ...
    $datosArray = $_hojasPre->post($postBody);
    header("Content-Type: application/json");
